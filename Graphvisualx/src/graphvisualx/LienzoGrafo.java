...
class LienzoGrafo extends JPanel
{
     ...
     * @param x parámetro formal de tipo entero que representa la coordenada
     * x de la arista
     * @param y parámetro formal de tipo entero que representa la coordenada
     * y de la arista
     * @return devuelve un tipo booleano que especifica si existe arista 
     * para dupla de parámetros (true) o no (false).
     */
    
    private boolean ExisteArista(int x, int y)
    {
    ...
    public void grafo_resultante(int [][] matriz, boolean ady, boolean dir, int origen_nodo)
    {
	...
	aristas_ = new ArrayList<CamposArista>();
        dirigido = dir;
        adyacente = ady;
        nodo_origen_seleccionado = origen_nodo;
	...
	public void drawArrow(Graphics2D h, int a, int b, int c, int d)
	{
	    ...
	    h.drawLine(x_a,y_a,destino_primero,destino_segundo); 
            System.out.println("Es dirigido el grafo y pinto");
            h.drawLine(a,b,c,d);
            }
            else{
                System.out.println("Es NO dirigido el grafo y pinto version 1");
	    h.drawLine(a,b,c,d);}
            ...
            else
            {
                ...
                if(ComprobarNodo(a,b) == vector_resultado.get(i).primero() && ComprobarNodo(c,d) == vector_resultado.get(i).segundo())
                {
                    ...
                    */
                    ...
                    h.drawLine(x_a,y_a,destino_primero,destino_segundo); 
                    System.out.println("Es dirigido el grafo y pinto version 2");
                    h.drawLine(a,b,c,d);
                    }else{
                        System.out.println("Es NO dirigido el grafo y pinto version 2");
                    h.drawLine(a,b,c,d);}
	...
	public void mouseReleased( MouseEvent evento )
	{
	    ...
	    if(!continuar)
		{
		    ...
		    else
			{
				...
				{
                                    System.out.println("modifico arista");
				    arista_modificar = -1;
