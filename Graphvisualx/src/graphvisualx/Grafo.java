...
public class Grafo {
    ...
    private int primer_nodo_topo_ = 0;
     ...
     * @param vertice valor entero que se corresponde con un nodo del grafo (debe de existir).
    ...
    {
	Algoritmos A = new Algoritmos(adyacencia,dirigido);
	...
	Algoritmos A = new Algoritmos();
        ...
        primer_nodo_topo_ = A.nodo_origen_topo();
    ...
    public int primer_nodo_topo()
    {
        return primer_nodo_topo_;
    }
    ...
    /**
     * Método privado
     * Devuelve la estructura interna del grafo de trabajo actual o el 
     * que se haya pasado por parámetro formal a la función u objeto que
     * llame a dicho método.
     * @param matriz_costes array bidimensional de valores tipo int cuyo
     * contenido es la matriz de costes del grafo de trabajo
     * actual o cualquier otro array pasado por dicho parámetro formal.
     * @return Devuelve la estructura interna del grafo en formato array
     * bidimensional de valores tipo int cuyo contenido será la matriz de 
     * adyacencia resultante de la transformación de la matriz de costes
     * pasada como parámetro formal.
     */
