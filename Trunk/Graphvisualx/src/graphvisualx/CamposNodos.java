...
public class CamposNodos {
    ...
    /*
     * Se empleará para almacenar el radio del nodo con respecto al punto
     * central o coordenadas centrales que se toman como punto de referencia
     * a la hora de interpretar a un nodo.
     */
