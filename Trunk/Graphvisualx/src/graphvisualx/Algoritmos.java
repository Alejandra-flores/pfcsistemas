...
public class Algoritmos{
    ...
    */
    ...
    public Algoritmos(boolean adyacente)
    {
	...
	*/
	...
	for(int i=0; i < tama_G; ++i)
	    for(int j=0; j < hash_puentes.get(i).size(); ++j)
		{
			...
			//System.out.println("Hasta aqui llego _ 2");	
			}

		    if(siguiente)
			if(puentes_rec(i,hash_puentes.get(i).get(j),tama_G))
			    {
				//System.out.println("Puente en: i:"+i+" j:"+hash_puentes.get(i).get(j));
