...
public class Grafico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelTexto1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Propiedades ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(76, 71, 209))); // NOI18N
        ...
        PanelTexto2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Propiedades", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(76, 71, 209))); // NOI18N
        ...
        BarraEdicionResultado.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Edición grafo resultante", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(76, 71, 209))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jToolBar1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(PanelTexto1, 0, 144, Short.MAX_VALUE)
                    .addComponent(PanelTexto2, javax.swing.GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE))
                .addGap(164, 164, 164))
        );
    ...
    private void MenuItemGuiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemGuiaActionPerformed
        ...
        try
        {
            JFrame Ventana2 = new JFrame("Guía de usuario");
            JEditorPane editor = new JEditorPane();
            JScrollPane scroll = new JScrollPane(editor);
            Ventana2.getContentPane().add(scroll);
        
            StringWriter writer = new StringWriter();
            IOUtils.copy(ClassLoader.getSystemResourceAsStream("index"), writer);
            String texto = writer.toString();
            System.out.println("Contenido de la pagina: "+texto);
            editor.setPage(texto);
            
            /*editor.setContentType("text/html");
        
            File archivo = new File("src/graphvisualx/index.html");
            editor.setPage("file://localhost/"+archivo.getAbsolutePath());*/
        
            Ventana2.setBounds(330, 300, getWidth(), getHeight());
        ...
        /*final JDialog Ventana2 = new JDialog(this,"Guia de usuario",true);
        
        JLabel JL_1 = new JLabel(" Formato de los ficheros:");
        JLabel JL_2 = new JLabel(" Seguir la estructura que se facilita en el fichero de prueba. ");
        JLabel JL_3 = new JLabel(" No se podrán incluir coste negativos para el fichero.");
        JLabel JL_4 = new JLabel(" Insercción de datos:");
        JLabel JL_5 = new JLabel(" Seguir las instrucciones que vayan mostrándose en pantalla.");
        JLabel JL_6 = new JLabel(" ");
        JLabel JL_7 = new JLabel(" ");
        JLabel JL_8 = new JLabel(" ");
               

        JL_1.setBounds(20,20,450,25);
        JL_2.setBounds(20,45,450,25);
        JL_3.setBounds(20,70,400,25);
        JL_4.setBounds(20,95,400,25);
        JL_5.setBounds(20,140,450,25);
        JL_6.setBounds(20,165,400,25);
        JL_7.setBounds(20,190,400,25);
        JL_8.setBounds(20,215,400,25);
        
        
        JButton salir_ventana = new JButton("Volver");
        
        salir_ventana.setBounds(20,200,100,25);
    ...
    private void MenuItemAlgoConceptosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemAlgoConceptosActionPerformed
        AbrirFichero fichero = new AbrirFichero(false,false,false);
                    ...
                    if(Grafico.this.pintar_algoritmo != null)
                    {
                       ...
                       do{
                            ...
                            */
                            ...
                            if(vertice_origen >= 0)
                            {
                                //System.out.println("vertice_origen:"+vertice_origen);
                                try {
                                    //System.out.println("Pinto en el lienzo 2");
                                    ...
                                    //System.out.println("Tamaño matriz: "+matriz_auxiliar.length);
                                    
                                    
                                    Grafico.this.pintar_algoritmo = new LienzoGrafo();
                                    Grafico.this.pintar_algoritmo.modificar_vector(auxiliar);
                                    Grafico.this.pintar_algoritmo.grafo_resultante(grafo.devolver_matriz(),grafo.es_adyacencia(),grafo.es_dirigido());
            ...
            @Override
                   public void itemStateChanged(ItemEvent evento)
                   {
                       try {
                           ...
                           for(int i=0; i < matrix_1.length; i++)
                               for(int j=0; j < matrix_1.length; j++)
                               {
                                 if(matrix_1[i][j] != matrix_2[i][j])
                                 {
                                        ...
                                        //System.out.println("ROJO Origen: "+p.primero()+" Destino: "+p.segundo());
                                 ...
                                 if(matrix_1[i][j] == matrix_2[i][j] && matrix_2[i][j] != 0)
                                 {
                                     ...
                                     auxiliar_2.add(p);
                                     grafo_resultado.nueva_arista(p.primero(), p.segundo(),matrix_2[i][j]);
                                     //System.out.println("Origen: "+p.primero()+" Destino: "+p.segundo());
                           ...
                           Grafico.this.pintar_algoritmo.grafo_resultante(grafo.Floyd(),grafo.es_adyacencia(),grafo.es_dirigido());
            ...
            @Override
                   public void itemStateChanged(ItemEvent evento)
                   {
                     ...
                     try {
                        ...
                        ArrayList<Par> auxiliar = new ArrayList<Par>();
                        Par p = new Par();
                        //int [][] matriz = new int [grafo.n_nodos()][grafo.n_nodos()];
    ...
    private void MenuItemGuardarImagenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemGuardarImagenActionPerformed
        ...
        {         
                ...
                try {
                    DibujaGrafo dg = new DibujaGrafo(grafo.devolver_matriz(),grafo.es_adyacencia());
                } catch (Exception ex) {
                    Logger.getLogger(Grafico.class.getName()).log(Level.SEVERE, null, ex);
                }
        }
    ...
    private void MenuItemGuardarImagenResultadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemGuardarImagenResultadoActionPerformed
        ...
        {         
                ...
                try {
                    DibujaGrafo dg = new DibujaGrafo(grafo_resultado.devolver_matriz(),grafo_resultado.es_adyacencia());
                } catch (Exception ex) {
                    Logger.getLogger(Grafico.class.getName()).log(Level.SEVERE, null, ex);
                }
        }
    ...
    private void BotonGradoVerticeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGradoVerticeActionPerformed
        ...
        try{
            ...
            do
            {
             ...
             JOptionPane.showMessageDialog(null,"El grado del vértice es "+grafo.grado_nodo(Integer.parseInt(texto)), "Grado de un vértice", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void BotonPuentesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonPuentesActionPerformed
        ...
        try
        {
            ...
            for(int i=0; i < resultado.size(); i++)
            {
               p = new Par(resultado.get(i).v_origen(),resultado.get(i).v_destino());
               auxiliar.add(p);
               //System.out.println("PUENTES Fuente: "+p.primero()+" Destino: "+p.segundo());
    ...
    private void BotonGradoVerticeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGradoVerticeBActionPerformed
        ...
        try{
            ...
            do
            {
             ...
             JOptionPane.showMessageDialog(null,"El grado del vértice es"+grafo_resultado.grado_nodo(Integer.parseInt(texto)), "Grado de un vértice", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void PanelTextoContenidoB() throws Exception
    {
        ...
        EtiquetaPuntosCorteB.setText("Puntos de corte: "+corte);
        }   
        
        if(puentes_ != null)
        {
            for(int i=0; i < puentes_.size(); i++)
            {
               puente = puente.concat("("+puentes_.get(i).v_origen()+","+puentes_.get(i).v_destino()+")");
               
               if(i+1 < puentes_.size())
                   puente = puente.concat(", ");
                            
            }
            
            EtiquetaPuentesB.setText("Puentes: "+puente);
        }*/
    }
    ...
    private void PanelTextoContenido() throws Exception
    {
        ...
        for(int i=0; i < puntos_cortes.size(); i++)
        {
            ...
            //System.out.println("x - Puntos de corte son"+corte);
        }
        EtiquetaPuntosCorte.setText("Puntos de corte: "+corte);
        }

        //System.out.println("Puntos de corte son"+corte);
    }
